...
- [#59](https://github.com/germ-network/autonomous-comm-protocol/pull/59) [`d647004`](https://github.com/germ-network/autonomous-comm-protocol/commit/d647004ed104bc8838aef9f4475c4625cb1033fe) Thanks [@germ-mark](https://github.com/germ-mark)! - Widen the `swift-crypto` dependency to `from: "5.0.0"` as part of the org-wide
...
- [#50](https://github.com/germ-network/autonomous-comm-protocol/pull/50) [`19dfab0`](https://github.com/germ-network/autonomous-comm-protocol/commit/19dfab0156bce879b74e1ac50d77bde145647fae) Thanks [@germ-mark](https://github.com/germ-mark)! - Re-base `DefinedWidthBinary.init(wireFormat:)` so it stores its payload as a
...
- [#48](https://github.com/germ-network/autonomous-comm-protocol/pull/48) [`dc5da94`](https://github.com/germ-network/autonomous-comm-protocol/commit/dc5da9413a547cb5526af7b62ff2527d318c7642) Thanks [@germ-mark](https://github.com/germ-mark)! - Pin `swift-cbor` to `from: "0.1.0"` instead of a revision. The revision pin
